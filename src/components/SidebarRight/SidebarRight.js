...
const SidebarRight = () => {
  const data = [
    {
      title: "RikkeiSoft",
      decription: "81 Quang Trung St, Hai Chau District, Đa Nang City",
    ...
    },
    {
      ...
      decription: "7 Phan Chau Trinh St, Hai Chau District, Đa Nang City",
  ...
  return (
    <div className="layout-sidebar-right">
      <Sider width={280} className="site-layout-background">
        <p
          style={{ color: "#00358E", fontWeight: "bold", fontSize: "20px", textAlign: "center", marginTop: "10px" }}
        >
          Most Popular
        </p>
